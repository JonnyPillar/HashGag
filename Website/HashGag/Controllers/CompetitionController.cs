...
namespace HashGag.Controllers
{
    public class CompetitionController : Controller
    {
        ...
        public ActionResult Details(string id)
        {
            ...
            CompetitionViewModel cmodel = new CompetitionViewModel(question1, highestscoringOrderedTweets, null, null);

            return View("Index", cmodel);


            return View("CompQuestionListView", cmodel.ColumnOneQuestions);
        }
